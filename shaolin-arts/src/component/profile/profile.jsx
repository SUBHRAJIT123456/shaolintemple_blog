...
//       ...user,
//       ...formData,
//       profileImage: formData.profileImage ? URL.createObjectURL(formData.profileImage) : user.profileImage,
//     };
...
//       ? require(`../../component/assets/images/${user.profileImage}`).default
//       : null;
//   } catch (error) {
//     profileImage = null;
//   }
...
const Profile = () => {
  ...
  useEffect(() => {
    if (user) {
      ...
      setProfileImage(user.profileImage); // Set initial profile image
      console.log('Profile User Data:', user);
    }
  }, [user]);
  ...
  const handleImageChange = (e) => {
    ...
    if (file) {
      ...
      reader.onloadend = () => {
        setProfileImage(reader.result); // Convert to base64
      };
  ...
  const handleCancelEdit = () => {
    ...
    setProfileImage(user.profileImage); // Reset to original image
  };
      ...
      {isEditing ? (
        ...
        <div className="profile-details">
          ...
          <img
            ...
            alt="Profile"
            style={{ width: '150px', height: '150px', objectFit: 'cover' }} // Fixed size
          />
          <p><strong>First Name:</strong> {user.firstName}</p>
          <p><strong>Last Name:</strong> {user.lastName}</p>
          <p><strong>Email:</strong> {user.email}</p>
